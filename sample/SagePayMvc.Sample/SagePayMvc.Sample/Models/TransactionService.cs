...
namespace SagePayMvc.Sample.Models {
    ...
    public interface ITransactionService {
        TransactionRegistrationResponse SendTransaction(IShoppingBasket storeBasket, IUrlHelper urlHelper, User user, HttpContext httpContext);
    }
    ...
    public class TransactionService : ITransactionService {
        ...
        public TransactionRegistrationResponse SendTransaction(IShoppingBasket storeBasket, IUrlHelper urlHelper, User user, HttpContext httpContext) {
            ...
            foreach (var item in storeBasket.GetItemsInBasket(httpContext)) {
            ...
            var response = _transactionRegistrar.Send(urlHelper, orderId, basket, sagePayAddress, sagePayAddress, null);
