...
namespace SagePayMvc
{
    ...
    public class Configuration
    {
        ...
        public const string SimulatorRefundUrl =
                ...
                if (!string.IsNullOrEmpty(value))
                {
                    if (value != "http" && value != "https")
                    {
                        throw new NotSupportedException(
                            "Protocol '{0}' is not supported. Allowed values are http or https");
                    }
        ...
        public string NotificationHostName
        {
            get
            {
                ...
                {
                    throw new ArgumentNullException("notificationHostName",
                        "NotificationHostName must be specified in the configuration.");
                }
        ...
        static Configuration LoadConfigurationFromConfigFile()
        {
            ...
            configurationRoot.GetSection("sagePay").Bind(configuration);
